## 'makeCacheMatrix' creates container for storing inverse matrix
## 'cacheSolve' uses this container for calculating inverse matrix 
## or returning previously cached one
